...
public class TypeSystemLabel: UILabel {
    // MARK: - Properties
    private let textStyle: TypeSystemStyle
    
    public var textTypeSystemColor: TypeSystemColor? {
        didSet {
            let fontAttributes = fontAttributes(
                textColor: textTypeSystemColor ?? .white
            )
            textColor = fontAttributes.textColor
        }
    }
    
    // MARK: - Intializer
    public init(_ style: TypeSystemStyle, textColor color: TypeSystemColor = .white) {
    ...
    // MARK: - Helpers
    private func setupAttributes(_ textStyle: TypeSystemStyle, textColor color: TypeSystemColor) {
        let attributes = fontAttributes(textStyle, textColor: color)
...
extension TypeSystemLabel {
    private func fontAttributes(_ textStyle: TypeSystemStyle = .title, textColor color: TypeSystemColor = .white) -> FontAttributes {
        switch textStyle {
        case .title:
...
extension TypeSystemLabel {
    private func setupBasicAttributes(_ attributes: FontAttributes) {
        font = UIFont(
    ...
    private func setupDetailAttributes(_ attributes: FontAttributes) {
...
extension TypeSystemLabel.FontAttributes {
    fileprivate var fontFamily: DesignSystemFontConvertible {
        switch weight {
        case .black:
