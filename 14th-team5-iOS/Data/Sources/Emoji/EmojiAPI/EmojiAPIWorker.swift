...
extension EmojiAPIWorker: EmojiRepository {
    public func addEmoji(query: Domain.AddEmojiQuery, body: Domain.AddEmojiBody) -> RxSwift.Single<Domain.AddEmojiData?> {
        ...
        return request(spec: spec, headers: [BibbiHeader.acceptJson, BibbiHeader.xAuthToken("eyJyZWdEYXRlIjoxNzA0MDIzMTcyNDIwLCJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsInR5cGUiOiJhY2Nlc3MifQ.eyJ1c2VySWQiOiIwMUhKQk5YQVYwVFlRMUtFU1dFUjQ1QTJRUCIsImV4cCI6MTcwNDEwOTU3Mn0.tmrN-Mr2Z1C7XgjBqPY_wDuF4Q6O24pGsM--Vod3heM")], jsonEncodable: requestDTO)
