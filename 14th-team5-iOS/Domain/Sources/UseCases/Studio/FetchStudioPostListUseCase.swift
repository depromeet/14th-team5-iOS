//
//  FetchAIPostListUseCaseProtocol.swift
//  Domain
//
...
public protocol FetchStudioPostListUseCaseProtocol {
    func execute(query: AIPostListQuery) -> Observable<PostListPageEntity?>
    func execute(query: AIPostListQuery) -> Observable<[PostEntity]?>
}

public class FetchStudioPostListUseCase: FetchStudioPostListUseCaseProtocol {
    ...
    public func execute(query: AIPostListQuery) -> Observable<[PostEntity]?> {
        return postListRepository.fetchAIPostList(query: query)
    ...
    public func execute(query: AIPostListQuery) -> Observable<PostListPageEntity?> {
        return postListRepository.fetchAIPostList(query: query)
...
// TODO: FetchPostListUseCase와 합치기
extension FetchStudioPostListUseCase {
